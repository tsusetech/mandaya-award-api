...
export class GroupsController {
  ...
  @Get('my-groups')
  @ApiOperation({
    summary: "Get current user's assigned groups with questions",
  })
  @ApiResponse({
    status: HttpStatus.OK,
  ...
  @ApiResponse({
    ...
    description: 'Group not found or user not assigned to this group',
  })
  async getMyGroupById(
    @Request() req,
  ...
  @ApiResponse({
    status: HttpStatus.BAD_REQUEST,
    description: 'User is already assigned to this group',
  })
  @Roles('ADMIN', 'SUPERADMIN')
  @UseGuards(RolesGuard)
  assignUserToGroup(
  ...
  @Post(':id/users/bulk')
  @ApiOperation({
    summary: 'Assign multiple users to group (Admin/SuperAdmin only)',
  })
  @ApiResponse({
    status: HttpStatus.CREATED,
  ...
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Group not found or one or more users not found',
  })
  @ApiResponse({
    status: HttpStatus.BAD_REQUEST,
    description: 'One or more users are already assigned to this group',
  })
  @Roles('ADMIN', 'SUPERADMIN')
  @UseGuards(RolesGuard)
  assignUsersToGroup(
  ...
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'User is not assigned to this group',
  })
  @Roles('ADMIN', 'SUPERADMIN')
  @UseGuards(RolesGuard)
  removeUserFromGroup(
  ...
  @ApiResponse({
    status: HttpStatus.CREATED,
    description: 'Question bound to group successfully',
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Group or question not found',
  })
  @ApiResponse({
    status: HttpStatus.BAD_REQUEST,
    description:
      'Question is already bound to this group or order number conflict',
  })
  @Roles('ADMIN', 'SUPERADMIN')
  @UseGuards(RolesGuard)
  bindQuestionToGroup(
  ...
  @ApiOperation({
    summary: 'Bind multiple questions to group (Admin/SuperAdmin only)',
  })
  @ApiResponse({
    status: HttpStatus.CREATED,
    description: 'Multiple questions bound to group successfully',
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Group or one or more questions not found',
  })
  @ApiResponse({
    status: HttpStatus.BAD_REQUEST,
    description:
      'One or more questions already bound to group or order number conflicts',
  })
  @Roles('ADMIN', 'SUPERADMIN')
  @UseGuards(RolesGuard)
  bindMultipleQuestionsToGroup(
    ...
    return this.groupsService.bindMultipleQuestionsToGroup(
      groupId,
      bindMultipleQuestionsDto,
    );
  }
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Group question updated successfully',
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Group question not found',
  })
  @ApiResponse({
    status: HttpStatus.BAD_REQUEST,
  ...
  updateGroupQuestion(
    ...
    return this.groupsService.updateGroupQuestion(
      groupQuestionId,
      updateGroupQuestionDto,
    );
  }
  ...
  @ApiOperation({
    summary: 'Remove question from group (Admin/SuperAdmin only)',
  })
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Question removed from group successfully',
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Question is not bound to this group',
  })
  @Roles('ADMIN', 'SUPERADMIN')
  @UseGuards(RolesGuard)
  ...
  @ApiOperation({
    summary: 'Reorder questions in group (Admin/SuperAdmin only)',
  })
  @ApiResponse({
    status: HttpStatus.OK,
  ...
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Group not found or one or more group questions not found',
  })
  @ApiResponse({
    status: HttpStatus.BAD_REQUEST,
    description: 'Duplicate order numbers detected',
  })
  @Roles('ADMIN', 'SUPERADMIN')
  @UseGuards(RolesGuard)
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Questions in group retrieved successfully',
  })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Group not found' })
  @Roles('ADMIN', 'SUPERADMIN')
  @UseGuards(RolesGuard)
  ...
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Soft deleted group not found',
  })
  @Roles('SUPERADMIN')
  @UseGuards(RolesGuard)
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Group permanently deleted successfully',
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Soft deleted group not found',
  ...
  @ApiOperation({
    summary:
      'Create tahap group for cross-subsection calculations (Admin/SuperAdmin only)',
  })
  @ApiResponse({
    status: HttpStatus.CREATED,
    description: 'Tahap group created successfully',
  })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Group not found' })
  @ApiResponse({
    status: HttpStatus.BAD_REQUEST,
    description:
      'One or more questions not bound to group or tahap group already exists',
  })
  @Roles('ADMIN', 'SUPERADMIN')
  @UseGuards(RolesGuard)
  createTahapGroup(
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Tahap group updated successfully',
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Group or tahap group not found',
  })
  @ApiResponse({
    status: HttpStatus.BAD_REQUEST,
    description: 'Tahap group already exists or questions not bound to group',
  })
  @Roles('ADMIN', 'SUPERADMIN')
  @UseGuards(RolesGuard)
  updateTahapGroup(
    ...
    return this.groupsService.updateTahapGroup(
      groupId,
      groupIdentifier,
      updateTahapGroupDto,
    );
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Tahap group deleted successfully',
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Group or tahap group not found',
  ...
  @Get(':id/tahap-groups')
  @ApiOperation({
    summary: 'Get all tahap groups in a group (Admin/SuperAdmin only)',
  })
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Tahap groups retrieved successfully',
  })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Group not found' })
  @Roles('ADMIN', 'SUPERADMIN')
  @UseGuards(RolesGuard)
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Tahap group details retrieved successfully',
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Group or tahap group not found',
  ...
  @ApiOperation({
    summary: 'Get cross-subsection tahap groups (Admin/SuperAdmin only)',
  })
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Cross-subsection groups retrieved successfully',
  })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Group not found' })
  @Roles('ADMIN', 'SUPERADMIN')
  @UseGuards(RolesGuard)
